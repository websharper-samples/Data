...
{
 "use strict";
 var Global,Workbooks,Education,Client,WebSharper,Operators,Obj,UI,Doc,View,SC$1,Client$1,Templates,JavaScript,Pervasives,Array,Arrays,Charting,Charts,LineChart,Chart,Renderers,ChartJs,Snap,Seq,Random,Pervasives$1,Color,HtmlModule,attr,EventTarget,Node,JS,Collections,Dictionary,DomUtility,Unchecked,List,T,Object,Concurrency,FSharp,Data,Runtime,WorldBank,Indicator,CompositeChart,ChartJsInternal,Abbrev,Async,Docs,Data$1,WBRuntime,WorldBankRuntime,Enumerator,T$1,AttrProxy,SC$2,HashSet,WindowOrWorkerGlobalScope,SC$3,DocElemNode,CharacterData,AsyncBody,List$1,SeriesChartConfig,ChartConfig,ColorConfig,Control,FSharpEvent,SC$4,SC$5,WorldBankCountry,Pervasives$2,Attrs,DictionaryUtil,Prepare,Slice,Option,KeyCollection,An,Settings,Mailbox,Attrs$1,Dyn,Elt,CT,Scheduler,Event,Event$1,PolarData,AttrModule,Element,HTMLElement,BatchUpdater,Util,Seq$1,IntelliFactory,Reactive,Reactive$1,Reactive$2,Strings,System,Guid,Docs$1,RunState,NodeSet,Anims,SC$6,Updates,Error,OperationCanceledException,SC$7,Queue,Fresh,SC$8,AppendList,SC$9,CancellationTokenSource,Disposable,HashSetUtil,Easing,HashSet$1,Observer,SC$10,DomNodes,Lazy,SC$11,LazyExtensionsProxy,LazyRecord,Math,Runtime$1,console,$,Chart$1,Date;
 Global=self;
 Workbooks=Global.Workbooks=Global.Workbooks||{};
 Education=Workbooks.Education=Workbooks.Education||{};
 Client=Education.Client=Education.Client||{};
 ...
 SC$1=Global.StartupCode$Data$Client=Global.StartupCode$Data$Client||{};
 ...
 WBRuntime=Data$1.WBRuntime=Data$1.WBRuntime||{};
 ...
 SC$5=Global.StartupCode$WebSharper_Charting$Renderers=Global.StartupCode$WebSharper_Charting$Renderers||{};
 WorldBankCountry=WBRuntime.WorldBankCountry=WBRuntime.WorldBankCountry||{};
 Pervasives$2=Data$1.Pervasives=Data$1.Pervasives||{};
 ...
 Seq$1=Pervasives$1.Seq=Pervasives$1.Seq||{};
 ...
 Reactive$2=Pervasives$1.Reactive=Pervasives$1.Reactive||{};
 ...
 {
  var chrt1,chrt2,a,a$1,a$2;
  chrt1=Doc.EmbedView(View.MapAsync(Global.id,View.Const(Client.chart(Client.schoolEnrollment()))));
  chrt2=Doc.EmbedView(View.MapAsync(Global.id,View.Const(Client.chart(Client.gdpPerCapita()))));
  a=Client.legend();
  Templates.LoadLocalTemplates("");
  Doc.RunById("countries",a);
  a$1=Doc.Concat([Doc.Element("h4",[],[Doc.TextNode("Tertiary school enrollment (% gross)")]),chrt1]);
  Templates.LoadLocalTemplates("");
  Doc.RunById("tertiary-enrollment",a$1);
  a$2=Doc.Concat([Doc.Element("h4",[],[Doc.TextNode("GDP per capita (in USD)")]),chrt2]);
  Templates.LoadLocalTemplates("");
  Doc.RunById("gdp-per-capita",a$2);
 };
 Client.legend=function()
 {
  SC$1.$cctor();
  return SC$1.legend;
 };
 Client.chart=function(source)
 {
  var cfg,b;
  cfg={};
  b=null;
  ...
  {
   return Concurrency.Bind(source,function(a)
   {
    var a$1;
    function m(c,e)
    {
     return Chart.Line$1(e).__WithStrokeColor(c).__WithPointColor(c);
    }
    return Concurrency.Return(ChartJs.Render$2(Chart.Combine(Arrays.map(function($1)
    {
     return m($1[0],$1[1]);
    },(a$1=Arrays.map(Client.mkData,a),Arrays.zip(Client.colors(),a$1)))),{
     $:1,
     $0:{
      $:0,
      $0:600,
 ...
 Client.gdpPerCapita=function()
 {
  SC$1.$cctor();
  return SC$1.gdpPerCapita;
 };
 Client.schoolEnrollment=function()
 {
  SC$1.$cctor();
  return SC$1.schoolEnrollment;
 };
 Client.mkData=function(i)
 {
  function f(t)
  {
   return t[1];
  ...
  function p(a,a$1)
  {
   return Operators.toInt(Global.Number(a));
  }
  return Seq.zip(Seq.map(Global.String,Arrays.ofSeq(Seq.sort(Seq.map(function(v)
  {
   return Operators.toInt(Global.Number(v));
  },JS.GetFieldNames(i))))),Arrays.ofSeq(Seq.map(function(x)
  {
   var x$1;
   x$1=f(x);
   return x$1;
  },Seq.sortBy(function($1)
  {
   return p($1[0],$1[1]);
  },JS.GetFields(i)))));
 };
 Client.colors=function()
 {
  SC$1.$cctor();
  return SC$1.colors;
 };
 ...
 Client.countries=function()
 {
  SC$1.$cctor();
  return SC$1.countries;
 };
 Client.randomColor=function()
 {
  SC$1.$cctor();
  return SC$1.randomColor;
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.schoolEnrollment=Concurrency.Parallel(Seq.map(function(c)
  {
   return WorldBankRuntime.AsyncGetIndicator(WorldBankRuntime.GetIndicators(c),"SE.ENR.TERT.FM.ZS");
  },Client.countries()));
  SC$1.gdpPerCapita=Concurrency.Parallel(Seq.map(function(c)
  {
   return WorldBankRuntime.AsyncGetIndicator(WorldBankRuntime.GetIndicators(c),"NY.GDP.PCAP.CD");
  },Client.countries()));
  SC$1.randomColor=(rand=new Random.New(),function()
  {
   return new Color({
    $:0,
    $0:rand.Next$1(256),
  ...
  SC$1.colors=Arrays.map(function()
  {
   return(Client.randomColor())();
  },Client.countries());
  SC$1.legend=Doc.Element("div",[],Arrays.map(function($1)
  {
   return m($1[0],$1[1]);
  },(a=Client.colors(),Arrays.zip(Client.countries(),a))));
 };
 ...
 Color=Pervasives$1.Color=Runtime$1.Class({
  toString:function()
  {
   return this.$==1?this.$0:this.$==2?this.$0:(((((Runtime$1.Curried(function($1,$2,$3,$4,$5)
   {
 ...
 Indicator=WorldBank.Indicator=Runtime$1.Class({},Obj,Indicator);
 ...
 ChartJsInternal.RenderCombinedLineChart=function(chart,size,cfg,window$1)
 {
  return ChartJsInternal.withNewCanvas(size,function(canvas)
  {
   ...
   labels=(e=Seq.map(function(s)
   {
    return Seq.map(m,s);
   },Seq.choose(function(chart$1)
   {
    var m$1;
 ...
 WorldBankRuntime.AsyncGetIndicator=function(country,indicator)
 {
  ...
  {
   var guid,r;
   guid=Pervasives$2.randomFunctionName();
   ...
   {
    return ko(new Error(textStatus+error));
   },r.success=function(data)
   {
    return ok(Pervasives.NewFromSeq(Arrays.choose(function(e)
    {
 ...
 Pervasives$2.randomFunctionName=function()
 {
  var c;
